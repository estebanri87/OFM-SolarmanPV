...
namespace DeyeMicro
{
    ...
    static const Spv::Def DEFS[Count] = {
        /* Power         */ {0x0056, 1, false, 0.1f, 0.0f, Spv::Float32},
        /* Today         */ {0x003C, 1, false, 0.1f, 0.0f, Spv::EnergyWh},
        /* Total         */ {0x003F, 2, false, 0.1f, 0.0f, Spv::EnergyWh},
        /* GridVoltage   */ {0x0049, 1, false, 0.1f, 0.0f, Spv::Float32},
        /* GridCurrent   */ {0x004C, 1, false, 0.1f, 0.0f, Spv::Float32},
        /* GridFrequency */ {0x004F, 1, false, 0.01f, 0.0f, Spv::Float32},
        /* Temperature   */ {0x005A, 1, false, 0.01f, 10.0f, Spv::Temp2},
        /* Pv1Voltage    */ {0x006D, 1, false, 0.1f, 0.0f, Spv::Float32},
        /* Pv1Current    */ {0x006E, 1, false, 0.1f, 0.0f, Spv::Float32},
        /* Pv1Power      */ {0x0000, 0, false, 0.0f, 0.0f, Spv::Float32},
        /* Pv2Voltage    */ {0x006F, 1, false, 0.1f, 0.0f, Spv::Float32},
        /* Pv2Current    */ {0x0070, 1, false, 0.1f, 0.0f, Spv::Float32},
        /* Pv2Power      */ {0x0000, 0, false, 0.0f, 0.0f, Spv::Float32},
        /* Today1        */ {0x0041, 1, false, 0.1f, 0.0f, Spv::EnergyWh},
        /* Today2        */ {0x0042, 1, false, 0.1f, 0.0f, Spv::EnergyWh},
        /* Total1        */ {0x0045, 2, false, 0.1f, 0.0f, Spv::EnergyWh},
        /* Total2        */ {0x0047, 2, false, 0.1f, 0.0f, Spv::EnergyWh},
    };
